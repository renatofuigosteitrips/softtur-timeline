...
aliases:
  - Timeline Bugs SoftTur
  - Softtur Timeline README
  - Timeline GitHub README
---
...
- Hub do sistema: [[hub-softtur]] — este timeline complementa o playbook geral de implantação
- Procedimento de deploy: [[Claude Code Deploy SoftTur Timeline]]
